...
* New model architecture introduced in [Attention is All You Need (Google, 2017)](https://arxiv.org/abs/1706.03762)
* Understands relationships between words in a document
* Applies attention weight between any inputs ("self-attention")

---

&shy; <!-- .element: class="stretch" --> ![transformer](images/transformer.webp)
